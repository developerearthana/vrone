...
import { BarChart2, BookOpen, PlusCircle, ListChecks } from 'lucide-react';

const links = [
    { name: 'Dashboard', href: '/kpi', icon: BarChart2, exact: true },
    { name: 'KPI Library', href: '/kpi/library', icon: BookOpen },
    { name: 'Assign', href: '/kpi/assign', icon: PlusCircle },
    { name: 'My KPIs', href: '/kpi/tracker', icon: ListChecks },
];
