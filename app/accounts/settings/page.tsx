        ...
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="glass-card p-6 rounded-xl space-y-6">
                ...
                <div className="pt-4 flex justify-end">
                    <button className="flex items-center gap-2 bg-primary text-primary-foreground px-6 py-2.5 rounded-lg hover:brightness-[1.08] transition-colors font-medium shadow-sm">
